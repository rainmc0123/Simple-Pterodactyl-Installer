...
print_summary() {
    ...
    echo -e "    ${NEON_GREEN}┃${NC}"
    echo -e "    ${NEON_GREEN}┃${NC}       ${STYLE_BOLD}${NEON_GREEN}⚡ INSTALLATION COMPLETE ⚡${NC}"
    echo -e "    ${NEON_GREEN}┃${NC}"
    echo ""
    echo -e "    ${DIM}Completed in ${duration}s${NC}"
    echo ""
    echo -e "    ${NEON_CYAN}┌──────────────────────────────────────────────────────────────────────────${NC}"
    echo -e "    ${NEON_CYAN}│${NC}  ${NEON_BLUE}▸${NC} ${WHITE}Panel${NC}"
    ...
    echo -e "    ${NEON_CYAN}├──────────────────────────────────────────────────────────────────────────${NC}"
    echo -e "    ${NEON_CYAN}│${NC}  ${NEON_PURPLE}▸${NC} ${WHITE}Database${NC}"
    ...
    echo -e "    ${NEON_CYAN}├──────────────────────────────────────────────────────────────────────────${NC}"
    echo -e "    ${NEON_CYAN}│${NC}  ${NEON_ORANGE}▸${NC} ${WHITE}Versions${NC}"
...
print_wings_summary() {
    ...
    echo -e "    ${NEON_GREEN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "    ${NEON_GREEN}┃${NC}"
    echo -e "    ${NEON_GREEN}┃${NC}       ${STYLE_BOLD}${NEON_GREEN}⚡ WINGS INSTALLATION COMPLETE ⚡${NC}"
    echo -e "    ${NEON_GREEN}┃${NC}"
    echo ""
    echo -e "    ${DIM}Completed in ${duration}s${NC}"
    echo ""
    echo -e "    ${NEON_CYAN}┌──────────────────────────────────────────────────────────────────────────${NC}"
    echo -e "    ${NEON_CYAN}│${NC}  ${NEON_BLUE}▸${NC} ${WHITE}Node${NC}"
...
print_uninstall_complete() {
    ...
    echo -e "    ${NEON_ORANGE}┃${NC}"
    echo -e "    ${NEON_ORANGE}┃${NC}       ${STYLE_BOLD}${NEON_ORANGE}⚡ UNINSTALL COMPLETE ⚡${NC}"
    echo -e "    ${NEON_ORANGE}┃${NC}"
    echo ""
